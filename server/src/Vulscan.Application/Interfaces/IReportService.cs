...
public interface IReportService
{
    ...
    /// </summary>
    Task<ExecutiveSummaryReportDto> GetExecutiveSummaryAsync(Guid? scanRunId = null, CancellationToken ct = default);

    /// <summary>
    /// Get summary list of all projects with vulnerability counts.
    /// </summary>
    Task<List<ProjectSummaryDto>> GetProjectSummariesAsync(Guid? scanRunId = null, CancellationToken ct = default);

    /// <summary>
    /// Get detailed report for a specific project (repos, packages, vulns).
    /// </summary>
    Task<ProjectDetailReportDto?> GetProjectReportAsync(Guid projectId, Guid? scanRunId = null, CancellationToken ct = default);
    ...
    /// </summary>
    Task<VulnerabilityDetailReportDto?> GetVulnerabilityReportAsync(string cveId, Guid? scanRunId = null, CancellationToken ct = default);
